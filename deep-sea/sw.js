// Offline support for the installed app. Serves from cache straight away, then refreshes the cache in the
// background, so a new version shows up the next time the app is opened.
const CACHE = 'deep-sea-v1';
